        ...
        switch (input_item.Type_Get()) {
            case CLI_INPUT_ITEM_TYPE_STR:
                ...
                if (Cli_Input.Input_Mode_Get() == INPUT_MODE_NORMAL) {
                    ...
                    if (s2 == "Q" || s2 == "quit") {
                        Cli_Output.Output_Str_Qt("Quit - Processed");
                        Cli_Output.Output_NewLine();
                    ...
                    if (input_item.Text_Get() == "Q" || input_item.Text_Get() == "quit") {
                        ...
                        Cli_Output.Output_Str_Qt("Clear - Processed");
                        Cli_Output.Output_NewLine();
                    } else if (input_item.Text_Get() == "A" || input_item.Text_Get() == "ask") {
                        Cli_Output.Output_Str_Qt("Is it right?(yes/no)");
                        ...
                        Cli_Output.Output_Str_Qt("Password:");
                        Cli_Input.Input_Str_Set_Empty();
                        ...
                        Cli_Output.Output_Str_Qt("Help: Q - quit, C - clear, H - help, A - prompt(y/n), P - password(no echo), W - wait");
                        Cli_Output.Output_NewLine();
                    } else if (input_item.Text_Get().length() > 0) {
                        Cli_Output.Output_Str_Qt(input_item.Text_Get() + " - Not Processed");
                        Cli_Output.Output_NewLine();
                    }
