...
/* 
 * File:   Cli_Module_Base_Wait_Qt.h
 * Author: mike
 *
 * Created on July 5, 2021, 11:05 AM
 */
...
class Cli_Module_Base_Wait_Qt : public Cli_Module {
protected:
...
public:
    ...
    Cli_Module_Base_Wait_Qt(bool &log_wait_enable, bool &cmd_wait_stop,
    ...
    virtual ~Cli_Module_Base_Wait_Qt() {
    }
