...
/* 
 * File:   cli_input_c_termios_main.c
 * Author: mike
 *
 * Created on July 2, 2020, 11:02 AM
 */
...
int main(int argc, char** argv) {
    ...
    struct Cli_Input_C_Termios Cli_Input_Termios = Cli_Input_C_termios();
    struct Cli_Input_C *Cli_Input = (struct Cli_Input_C *) &Cli_Input_Termios;
