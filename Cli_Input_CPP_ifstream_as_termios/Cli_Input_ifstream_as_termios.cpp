...
bool Cli_Input_ifstream_as_termios::Input_Init() {
...
bool Cli_Input_ifstream_as_termios::Input_Restore() {
    if (File_In.is_open()) {
        File_In.close();
    }
...
bool Cli_Input_ifstream_as_termios::Input_Clear() {
    return true;
}

void Cli_Input_ifstream_as_termios::Input_Add(char c) {
    Input_Str += c;
...
Cli_Input_Item Cli_Input_ifstream_as_termios::Input_Item_Get() {
...
bool Cli_Input_ifstream_as_termios::Input_sleep(int sleep_sec) {
#ifdef _WIN32
...
bool Cli_Input_ifstream_as_termios::Input_kbhit() {
    return false;
}
