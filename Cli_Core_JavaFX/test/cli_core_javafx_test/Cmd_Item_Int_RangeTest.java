 ...
 * @author mike
 */
public class Cmd_Item_Int_RangeTest {

    String Test_Name = this.getClass().getSimpleName();

    Cmd_Item_Int_Range v = new Cmd_Item_Int_Range(1, 32, "", "");
    ...
    final Cmd_Item_Test_Pair[] test_items = {
        ...
        new Cmd_Item_Test_Pair("32", Cmd_Item_Valid_Result.CMD_ITEM_OK),
        new Cmd_Item_Test_Pair("0", Cmd_Item_Valid_Result.CMD_ITEM_OUT_OF_RANGE),
        new Cmd_Item_Test_Pair("33", Cmd_Item_Valid_Result.CMD_ITEM_OUT_OF_RANGE)
    };
