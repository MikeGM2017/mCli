 ...
 * @author mike
 */
public class Cmd_Item_MACTest {

    String Test_Name = this.getClass().getSimpleName();

    Cmd_Item_MAC v = new Cmd_Item_MAC("", "");
    ...
    final Cmd_Item_Test_Pair[] test_items = {
        ...
        new Cmd_Item_Test_Pair("00:00:00:00:00:00", Cmd_Item_Valid_Result.CMD_ITEM_OK),
        new Cmd_Item_Test_Pair("00:00:00:00:00:0", Cmd_Item_Valid_Result.CMD_ITEM_INCOMPLETE_STR),
        new Cmd_Item_Test_Pair("00:00:00:00:00:0x", Cmd_Item_Valid_Result.CMD_ITEM_ERROR),
        new Cmd_Item_Test_Pair("00:00:00:00:00", Cmd_Item_Valid_Result.CMD_ITEM_INCOMPLETE_STR),
        new Cmd_Item_Test_Pair("00:00:00:00:00:FF", Cmd_Item_Valid_Result.CMD_ITEM_OK),
        new Cmd_Item_Test_Pair("FF:FF:FF:FF:FF:FF", Cmd_Item_Valid_Result.CMD_ITEM_OK)
    };
