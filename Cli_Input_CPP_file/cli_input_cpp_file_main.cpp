...
/* 
 * File:   cli_input_cpp_file_main.cpp
 * Author: mike
 *
 * Created on September 14, 2021, 10:33 AM
 */
...
void Help_Print() {
    cout << "Program Cli_Input_CPP_file" << endl;
    cout << "Use: cli_input_cpp_file [switches]" << endl;
...
int main(int argc, char** argv) {
    ...
    Cli_Input_file Cli_Input(Arg_File_In, Cli_Output);
