...
${OBJECTDIR}/Cli_Input/Cli_Input_ifstream.o: Cli_Input/Cli_Input_ifstream.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input/Cli_Input_ifstream.o Cli_Input/Cli_Input_ifstream.cpp

${OBJECTDIR}/Cli_Input/Cli_Input_termios.o: Cli_Input/Cli_Input_termios.cpp 
	${MKDIR} -p ${OBJECTDIR}/Cli_Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input/Cli_Input_termios.o Cli_Input/Cli_Input_termios.cpp

${OBJECTDIR}/cli_core_test_main.o: cli_core_test_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_core_test_main.o cli_core_test_main.cpp
...
${TESTDIR}/tests/Test_Cmd_Item_MAC.o: tests/Test_Cmd_Item_MAC.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_MAC.o tests/Test_Cmd_Item_MAC.cpp
...
${TESTDIR}/tests/Test_Cmd_Item_Str_Esc.o: tests/Test_Cmd_Item_Str_Esc.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Str_Esc.o tests/Test_Cmd_Item_Str_Esc.cpp
...
${TESTDIR}/tests/Test_Cmd_Item_Word.o: tests/Test_Cmd_Item_Word.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Word.o tests/Test_Cmd_Item_Word.cpp


${TESTDIR}/tests/Test_Cmd_Item_Word_List.o: tests/Test_Cmd_Item_Word_List.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Word_List.o tests/Test_Cmd_Item_Word_List.cpp
...
${OBJECTDIR}/Cli_Input/Cli_Input_ifstream_nomain.o: ${OBJECTDIR}/Cli_Input/Cli_Input_ifstream.o Cli_Input/Cli_Input_ifstream.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input/Cli_Input_ifstream_nomain.o Cli_Input/Cli_Input_ifstream.cpp;\
	else  \
