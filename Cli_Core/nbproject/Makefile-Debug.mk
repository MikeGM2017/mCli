...
LDLIBSOPTIONS=-L../lua-5.3.5/src -llua
...
${OBJECTDIR}/Cli_Input/Cli_Input_termios.o: Cli_Input/Cli_Input_termios.cpp 
	${MKDIR} -p ${OBJECTDIR}/Cli_Input
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input/Cli_Input_termios.o Cli_Input/Cli_Input_termios.cpp

${OBJECTDIR}/cli_core_test_main.o: cli_core_test_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_core_test_main.o cli_core_test_main.cpp
...
${TESTDIR}/tests/Test_Cmd_Item_Date.o: tests/Test_Cmd_Item_Date.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Date.o tests/Test_Cmd_Item_Date.cpp


${TESTDIR}/tests/Test_Cmd_Item_DateTime.o: tests/Test_Cmd_Item_DateTime.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_DateTime.o tests/Test_Cmd_Item_DateTime.cpp


${TESTDIR}/tests/Test_Cmd_Item_Int.o: tests/Test_Cmd_Item_Int.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Int.o tests/Test_Cmd_Item_Int.cpp


${TESTDIR}/tests/Test_Cmd_Item_Int_List.o: tests/Test_Cmd_Item_Int_List.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Int_List.o tests/Test_Cmd_Item_Int_List.cpp


${TESTDIR}/tests/Test_Cmd_Item_Int_Range.o: tests/Test_Cmd_Item_Int_Range.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Int_Range.o tests/Test_Cmd_Item_Int_Range.cpp


${TESTDIR}/tests/Test_Cmd_Item_IP4.o: tests/Test_Cmd_Item_IP4.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_IP4.o tests/Test_Cmd_Item_IP4.cpp


${TESTDIR}/tests/Test_Cmd_Item_IP6.o: tests/Test_Cmd_Item_IP6.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_IP6.o tests/Test_Cmd_Item_IP6.cpp


${TESTDIR}/tests/Test_Cmd_Item_MAC.o: tests/Test_Cmd_Item_MAC.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_MAC.o tests/Test_Cmd_Item_MAC.cpp
...
${TESTDIR}/tests/Test_Cmd_Item_Str_With_Commas.o: tests/Test_Cmd_Item_Str_With_Commas.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Str_With_Commas.o tests/Test_Cmd_Item_Str_With_Commas.cpp


${TESTDIR}/tests/Test_Cmd_Item_Time.o: tests/Test_Cmd_Item_Time.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Time.o tests/Test_Cmd_Item_Time.cpp


${TESTDIR}/tests/Test_Cmd_Item_Word.o: tests/Test_Cmd_Item_Word.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Word.o tests/Test_Cmd_Item_Word.cpp


${TESTDIR}/tests/Test_Cmd_Item_Word_List.o: tests/Test_Cmd_Item_Word_List.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Word_List.o tests/Test_Cmd_Item_Word_List.cpp


${TESTDIR}/tests/Test_Cmd_Item_Word_Range.o: tests/Test_Cmd_Item_Word_Range.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Cmd_Item_Word_Range.o tests/Test_Cmd_Item_Word_Range.cpp
...
${OBJECTDIR}/Cli_Input/Cli_Input_termios_nomain.o: ${OBJECTDIR}/Cli_Input/Cli_Input_termios.o Cli_Input/Cli_Input_termios.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input/Cli_Input_termios_nomain.o Cli_Input/Cli_Input_termios.cpp;\
	else  \
...
${OBJECTDIR}/cli_core_test_main_nomain.o: ${OBJECTDIR}/cli_core_test_main.o cli_core_test_main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -ICli_Core -ICli_Input -ICli_Output -ICli_Modules -ICmd_Item -ICmd_Token_Parser -ITAB_Cmd -ICli_History -ICli_CMD_Processor -ICli_TAB_Processor -ICli_Module_Test -I../lua-5.3.5/src -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_core_test_main_nomain.o cli_core_test_main.cpp;\
	else  \
