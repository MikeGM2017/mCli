...
/* 
 * File:   Cmd_Item_Word_Range.h
 * Author: mike
 *
 * Created on July 14, 2020, 12:48 PM
 */

#ifndef CMD_ITEM_WORD_RANGE_H
#define CMD_ITEM_WORD_RANGE_H

#include "Cmd_Item_Word.h"

class Cmd_Item_Word_Range : public Cmd_Item_Word {
public:

    vector<string> Words;

    Cmd_Item_Word_Range(string text, string help, vector<string> words) : Cmd_Item_Word(text, help), Words(words) {
        Type = "Word_Range";
    }
