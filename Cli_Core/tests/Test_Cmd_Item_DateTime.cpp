...
static const Cmd_Item_Test_Pair TestVector[] = {
    ...
    Cmd_Item_Test_Pair("\"2018-01\"", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair("\"2018-01-1", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair("\"2018-01-", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair("\"2018-01", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair("\"2018-01-18 12-01\"", CMD_ITEM_OK),
    Cmd_Item_Test_Pair("\"2018-01-18 15-03", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair("\"2018-01-18 15-0", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair("\"2018-01-18 ", CMD_ITEM_INCOMPLETE_STR),
