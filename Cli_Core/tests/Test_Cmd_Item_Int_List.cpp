...
static const Cmd_Item_Test_Pair TestVector[] = {
    ...
    Cmd_Item_Test_Pair("1", CMD_ITEM_OK_CAN_CONTINUE),
    Cmd_Item_Test_Pair("4095", CMD_ITEM_OK_CAN_CONTINUE),
    Cmd_Item_Test_Pair("0", CMD_ITEM_OUT_OF_RANGE),
    Cmd_Item_Test_Pair("4096", CMD_ITEM_OUT_OF_RANGE),
    Cmd_Item_Test_Pair("1,3,5", CMD_ITEM_OK_CAN_CONTINUE),
    Cmd_Item_Test_Pair("1,3,", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair(",3,", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair(",", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair(",,", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair("1,3,4096", CMD_ITEM_OUT_OF_RANGE),
    Cmd_Item_Test_Pair("1,3,32", CMD_ITEM_OK_CAN_CONTINUE),
    Cmd_Item_Test_Pair("1,3,32,", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair("1,3,,32", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair("1,3,32,,", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair("1-2", CMD_ITEM_OK_CAN_CONTINUE),
    Cmd_Item_Test_Pair("-", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair("1-", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair("-2", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair("6-2", CMD_ITEM_OUT_OF_ORDER),
    Cmd_Item_Test_Pair("5-20", CMD_ITEM_OK_CAN_CONTINUE),
    Cmd_Item_Test_Pair("100,5-20", CMD_ITEM_OK_CAN_CONTINUE),
    Cmd_Item_Test_Pair("100,5-20, 41,60", CMD_ITEM_ERROR),
    Cmd_Item_Test_Pair("100,5-20,41,60", CMD_ITEM_OK_CAN_CONTINUE),
    Cmd_Item_Test_Pair("100,5-20,41,60,", CMD_ITEM_INCOMPLETE_STR),
    Cmd_Item_Test_Pair("100,5-20,41,60,70-72,", CMD_ITEM_INCOMPLETE_STR),
