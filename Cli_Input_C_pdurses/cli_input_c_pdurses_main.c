...
/* 
 * File:   cli_input_c_pdurses_main.c
 * Author: mike
 *
 * Created on July 2, 2020, 5:28 PM
 */
...
int main(int argc, char** argv) {
    ...
    struct Cli_Input_C_PDCurses Cli_Input_PDCurses = Cli_Input_C_pdcurses();
    struct Cli_Input_C *Cli_Input = (struct Cli_Input_C *) &Cli_Input_PDCurses;
