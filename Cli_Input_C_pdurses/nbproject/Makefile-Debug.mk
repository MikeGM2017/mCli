...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cli_input_c_pdurses: ../PDCurses-3.8/sdl2/pdcurses.a
...
${OBJECTDIR}/Cli_Input_C.o: Cli_Input_C.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I../PDCurses-3.8/ -include ../PDCurses-3.8/curses.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input_C.o Cli_Input_C.c

${OBJECTDIR}/Cli_Input_C_Item.o: Cli_Input_C_Item.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I../PDCurses-3.8/ -include ../PDCurses-3.8/curses.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input_C_Item.o Cli_Input_C_Item.c

${OBJECTDIR}/Cli_Input_C_pdcurses.o: Cli_Input_C_pdcurses.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I../PDCurses-3.8/ -include ../PDCurses-3.8/curses.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input_C_pdcurses.o Cli_Input_C_pdcurses.c
...
${OBJECTDIR}/cli_input_c_pdurses_main.o: cli_input_c_pdurses_main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I../PDCurses-3.8/ -include ../PDCurses-3.8/curses.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_input_c_pdurses_main.o cli_input_c_pdurses_main.c
