...
${OBJECTDIR}/_ext/211101b3/Cli_Input_ncurses.o: /home/mike/NetBeansProjects7_Cli/Git/Cli_Input_CPP_ncurses/Cli_Input_ncurses.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/211101b3/Cli_Input_ncurses.o /home/mike/NetBeansProjects7_Cli/Git/Cli_Input_CPP_ncurses/Cli_Input_ncurses.cpp

${OBJECTDIR}/cli_input_cpp_ncurses_main.o: cli_input_cpp_ncurses_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_input_cpp_ncurses_main.o cli_input_cpp_ncurses_main.cpp
