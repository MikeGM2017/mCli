...
/* 
 * File:   Cli_QTextEdit.h
 * Author: mike
 *
 * Created on May 12, 2021, 8:55 AM
 */

#ifndef CLI_QTEXTEDIT_H
#define CLI_QTEXTEDIT_H
...
class Cli_QTextEdit : public QTextEdit {
protected:
...
public:
    ...
    Cli_QTextEdit(QWidget *parent = 0) : QTextEdit(parent) {
    }

    virtual ~Cli_QTextEdit() {
    }

};

#endif /* CLI_QTEXTEDIT_H */
