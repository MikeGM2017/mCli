...
/* 
 * File:   cli_input_cpp_file_as_termios_main.cpp
 * Author: mike
 *
 * Created on February 4, 2022, 1:26 PM
 */
...
void Help_Print() {
    cout << "Program Cli_Input_CPP_file_as_termios" << endl;
    cout << "Use: cli_input_cpp_file_as_termios [switches]" << endl;
...
int main(int argc, char** argv) {
    ...
    if (Arg_File_In.empty()) {
        cout << "ERROR: File In is not set" << endl;
        exit(1); // Failed
    }

    Cli_Output_cout Cli_Output;

    Cli_Input_file_as_termios Cli_Input(Arg_File_In, Cli_Output);
