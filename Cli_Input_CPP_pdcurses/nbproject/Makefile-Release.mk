...
${OBJECTDIR}/Cli_Input_pdcurses.o: Cli_Input_pdcurses.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input_pdcurses.o Cli_Input_pdcurses.cpp

${OBJECTDIR}/cli_input_cpp_pdcurses_main.o: cli_input_cpp_pdcurses_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_input_cpp_pdcurses_main.o cli_input_cpp_pdcurses_main.cpp
