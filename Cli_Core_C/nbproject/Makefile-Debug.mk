...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cli_core_c_test

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cli_core_c_test: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cli_core_c_test ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Cli_CMD_Processor.o: Cli_CMD_Processor.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_CMD_Processor.o Cli_CMD_Processor.c

${OBJECTDIR}/Cli_Cmd.o: Cli_Cmd.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Cmd.o Cli_Cmd.c
...
${OBJECTDIR}/Cli_Cmd_Item_Str.o: Cli_Cmd_Item_Str.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Cmd_Item_Str.o Cli_Cmd_Item_Str.c

${OBJECTDIR}/Cli_Cmd_Item_Word.o: Cli_Cmd_Item_Word.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Cmd_Item_Word.o Cli_Cmd_Item_Word.c

${OBJECTDIR}/Cli_Core.o: Cli_Core.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Core.o Cli_Core.c

${OBJECTDIR}/Cli_History.o: Cli_History.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_History.o Cli_History.c

${OBJECTDIR}/Cli_Input_C.o: Cli_Input_C.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input_C.o Cli_Input_C.c
...
${OBJECTDIR}/Cli_Input_C_termios.o: Cli_Input_C_termios.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Input_C_termios.o Cli_Input_C_termios.c

${OBJECTDIR}/Cli_Module.o: Cli_Module.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Module.o Cli_Module.c
...
${OBJECTDIR}/Cli_Module_Base_Quit.o: Cli_Module_Base_Quit.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Module_Base_Quit.o Cli_Module_Base_Quit.c
...
${OBJECTDIR}/Cli_Modules.o: Cli_Modules.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Modules.o Cli_Modules.c

${OBJECTDIR}/Cli_Output_C_file.o: Cli_Output_C_file.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Output_C_file.o Cli_Output_C_file.c

${OBJECTDIR}/Cli_Output_C_printf.o: Cli_Output_C_printf.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Output_C_printf.o Cli_Output_C_printf.c

${OBJECTDIR}/Cli_TAB_Processor.o: Cli_TAB_Processor.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_TAB_Processor.o Cli_TAB_Processor.c

${OBJECTDIR}/Cmd_Item_Valid_Result_Func.o: Cmd_Item_Valid_Result_Func.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cmd_Item_Valid_Result_Func.o Cmd_Item_Valid_Result_Func.c

${OBJECTDIR}/Cmd_Token.o: Cmd_Token.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cmd_Token.o Cmd_Token.c

${OBJECTDIR}/Cmd_Token_Array.o: Cmd_Token_Array.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cmd_Token_Array.o Cmd_Token_Array.c

${OBJECTDIR}/Cmd_Token_Parser.o: Cmd_Token_Parser.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cmd_Token_Parser.o Cmd_Token_Parser.c

${OBJECTDIR}/Cmd_Token_Parser_Char_Type_Func.o: Cmd_Token_Parser_Char_Type_Func.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cmd_Token_Parser_Char_Type_Func.o Cmd_Token_Parser_Char_Type_Func.c

${OBJECTDIR}/Level_Description.o: Level_Description.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Level_Description.o Level_Description.c

${OBJECTDIR}/Level_Description_Array.o: Level_Description_Array.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Level_Description_Array.o Level_Description_Array.c

${OBJECTDIR}/Mem_Manager_buf.o: Mem_Manager_buf.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mem_Manager_buf.o Mem_Manager_buf.c

${OBJECTDIR}/Mem_Manager_malloc_free.o: Mem_Manager_malloc_free.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mem_Manager_malloc_free.o Mem_Manager_malloc_free.c

${OBJECTDIR}/Str_Filter.o: Str_Filter.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Str_Filter.o Str_Filter.c

${OBJECTDIR}/Str_List_Item.o: Str_List_Item.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Str_List_Item.o Str_List_Item.c

${OBJECTDIR}/TAB_Cmd.o: TAB_Cmd.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TAB_Cmd.o TAB_Cmd.c

${OBJECTDIR}/cli_core_c_test_main.o: cli_core_c_test_main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cli_core_c_test_main.o cli_core_c_test_main.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cli_core_c_test
