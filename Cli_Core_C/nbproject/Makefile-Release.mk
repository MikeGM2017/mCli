...
${OBJECTDIR}/Cli_Module_Base_History.o: Cli_Module_Base_History.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Module_Base_History.o Cli_Module_Base_History.c

${OBJECTDIR}/Cli_Module_Base_Modules.o: Cli_Module_Base_Modules.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Module_Base_Modules.o Cli_Module_Base_Modules.c
...
${OBJECTDIR}/Cli_Module_Mem_Manager.o: Cli_Module_Mem_Manager.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cli_Module_Mem_Manager.o Cli_Module_Mem_Manager.c
