...
static int Input_Init(struct Cli_Input_C *obj) {
    ...
    return obj->Cli_Output->Output_Init(cli_output_obj);
}

static int Input_Restore(struct Cli_Input_C *obj) {
    struct Cli_Output_C *cli_output_obj = obj->Cli_Output;
    return obj->Cli_Output->Output_Close(cli_output_obj);
}

static int Input_Clear(struct Cli_Input_C *obj) {
    struct Cli_Output_C *cli_output_obj = obj->Cli_Output;
    return obj->Cli_Output->Output_Clear(cli_output_obj);
}
...
static void Input_Str_To_Output(struct Cli_Input_C *obj) {
    if (obj->Is_Echo_Get(obj)) {
        struct Cli_Output_C *cli_output_obj = obj->Cli_Output;
        obj->Cli_Output->Output_Return(cli_output_obj);
        obj->Cli_Output->Output_Str(cli_output_obj, Invitation_Full_Get(obj));
        if (obj->Input_Str_Pos > 0) {
            ...
            obj->Cli_Output->Output_Str(cli_output_obj, input_substr);
        }
    }
}
...
static void Input_Str_Modified_To_Output(struct Cli_Input_C *obj, char *s_prev) {
    if (obj->Is_Echo_Get(obj)) {
        ...
        obj->Cli_Output->Output_Return(cli_output_obj);
        obj->Cli_Output->Output_Str(cli_output_obj, obj->Invitation_Full_Get(obj));
        obj->Cli_Output->Output_Str(cli_output_obj, s_prev_space);

        obj->Cli_Output->Output_Return(cli_output_obj);
        obj->Cli_Output->Output_Str(cli_output_obj, obj->Invitation_Full_Get(obj));
        obj->Cli_Output->Output_Str(cli_output_obj, obj->Input_Str);
...
static void Input_Add(struct Cli_Input_C *obj, char c) {
    if (obj->Input_Str_Size < CLI_INPUT_C_INPUT_STR_SIZE) {
        if (obj->Input_Str_Pos == obj->Input_Str_Size) {
            if (obj->Is_Echo_Get(obj)) {
                struct Cli_Output_C *cli_output_obj = obj->Cli_Output;
                obj->Cli_Output->Output_Char(cli_output_obj, c);
            }
