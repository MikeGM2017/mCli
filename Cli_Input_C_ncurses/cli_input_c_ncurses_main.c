...
/* 
 * File:   cli_input_c_ncurses_main.c
 * Author: mike
 *
...
int main(int argc, char** argv) {
    ...
    struct Cli_Input_C_NCurses Cli_Input_NCurses = Cli_Input_C_ncurses();
    struct Cli_Input_C *Cli_Input = (struct Cli_Input_C *) &Cli_Input_NCurses;
